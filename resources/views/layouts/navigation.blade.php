<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- ADICIONA O LINK PARA ALUNOS AQUI --}}
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth {{-- MOSTRAR ESTE BLOCO APENAS SE HOUVER UM UTILIZADOR AUTENTICADO --}}
                ...
                @else {{-- MOSTRAR ESTE BLOCO SE NÃO HOUVER UTILIZADOR AUTENTICADO (CONVIDADO) --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- ADICIONA O LINK RESPONSIVO PARA ALUNOS AQUI --}}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else {{-- MOSTRAR LINKS DE LOGIN/REGISTO SE O UTILIZADOR FOR UM CONVIDADO --}}
